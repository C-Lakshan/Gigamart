      ...
      <>
        ...
        <div className='pt-4'>
          <form onSubmit={onSubmit} autoComplete='off'>
            ...
            <input type="password" name='confirmPassword' value={values?.confirmPassword} onChange={handleOnChange} placeholder='Confirm Password' className='h-[48px] mt-2 w-full border p-2 border-gray-400' required autoComplete='new-password'/>
