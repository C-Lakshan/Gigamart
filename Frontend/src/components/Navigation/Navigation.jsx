...
import { countWishlistItems } from '../../store/features/wishlist'; // ✅ Import wishlist count selector

const Navigation = ({ variant = "default" }) => {
  const cartLength = useSelector(countCartItems);
  const wishlistLength = useSelector(countWishlistItems); // ✅ Get wishlist count
